...
class DetectionMapper():
    ...
    def __init__(self):
		...
		#self.delete_sub = message_filters.Subscriber('delete', Int32)
		#self.delete_sub.registerCallback(self.delete_callback)
		self.delete_sub = rospy.Subscriber("cancelDetection", String, self.delete_callback)
		...
		self.markers_pub = rospy.Publisher('fmarkers', MarkerArray)
